...
func TestNewSarifReportFromContainerScanReport(t *testing.T) {
	for _, tt := range []struct {
		name    string
		input   containerscan.Report
		wantErr bool
		want    sarif.Report
	}{
		{
			name: "zero-value container scan report",
			want: sarif.Report{
				Version: "2.1.0",
		...
		{
			name: "container scan report with no vulnerabilities and no best practices violations",
			input: containerscan.Report{
		...
		{
			name: "container scan report with no vulnerabilities but best practices violations",
			input: containerscan.Report{
				ImageName:                  "myacr.azurecr.io/testapp:770aed6bd33d7240b4bdb55f16348ce37b86bb09",
				VulnerabilityScanTimestamp: "2021-03-05T09:38:48.036Z",
		...
		{
			name: "container scan report with vulnerabilities but no best practices violations",
			input: containerscan.Report{
				ImageName:                  "myacr.azurecr.io/testapp:770aed6bd33d7240b4bdb55f16348ce37b86bb09",
				VulnerabilityScanTimestamp: "2021-03-05T09:38:48.036Z",
		...
		{
			name: "container scan report with both vulnerabilities and best practices violations",
			input: containerscan.Report{
				ImageName:                  "myacr.azurecr.io/testapp:770aed6bd33d7240b4bdb55f16348ce37b86bb09",
				VulnerabilityScanTimestamp: "2021-03-05T09:38:48.036Z",
				Vulnerabilities: []containerscan.Vulnerability{
		...
		t.Run(tt.name, func(t *testing.T) {
			got, err := converter.NewSarifReportFromContainerScanReport(tt.input)
			if (err != nil) != tt.wantErr {
				t.Errorf("unexpected error state returned: %v, wantErr: %v", err, tt.wantErr)
			}
